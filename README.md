...
1. **Input** — typed text (`triggerSearch`) or a mood/preset button (`triggerPresetSearch`).
...
7. **Render** — `renderer.js` draws each card, including the score badge and the collapsible "Why?" match breakdown.
